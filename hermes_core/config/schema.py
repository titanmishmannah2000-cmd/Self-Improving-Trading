...
STRATEGY_PARAM_RANGES: dict[str, tuple[float, float]] = {
    ...
    "time_exit_max_cycles": (120, 2880),
    "early_reeval_cycles": (30, 720),
    "trailing_atr_mult": (0.5, 5.0),
    "mfe_giveback_min_pct": (0.1, 5.0),
    "mfe_giveback_frac": (0.1, 1.0),
    "min_bank_net_pct": (0.0, 2.0),
    "peak_epsilon_pct": (0.0, 1.0),
    "mfe_stall_bars": (1, 20),
    "clock_lock_frac": (0.1, 1.0),
    "path_slack": (0.5, 3.0),
    ...
    "probe_soft_cut_min_cycles": (30, 720),
    "probe_soft_cut_max_cycles": (60, 1440),
    "probe_soft_cut_mfe_pct": (0.05, 2.0),
    "bank_score_ceiling": (0.25, 0.7),
    "pullback_time_exit_cycles": (60, 2880),
